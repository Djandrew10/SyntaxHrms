...
public class AddEmployeeTest extends CommonMethods{
	...
	public Object[][] employeesData() {
		Object[][] data = { { "AnnaReaw", "AnneS12345)*)", "Annituaw", "Smitowl" },//next time the username can be changed only in order to add another employees on the web site
				{ "AndreiYeyw", "AndrewL123(**s", "Bibberrt", "Lockssrul" },
				{ "Benjaabee", "Ben12#%&*(*", "Benitro", "Mathewor" },
				{ "BeyorRkey", "BeyonceC23#$*)$", "Chabbythro&", "CarRorr" },
				{ "Jeseptee", "JessieR013#%*))", "EmilLrf", "Rodrigqorm" } };
		return data;
	}
    ...
    * and parameter: name of the sheet we need from the excel file "AddEmployee"
